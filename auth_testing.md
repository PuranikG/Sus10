# Auth Testing Playbook for Sus10 AI
...
curl -X GET "$API_URL/api/buildings/search?limit=5"

# Test providers endpoint  
curl -X GET "$API_URL/api/providers"

# Test initiatives endpoint
curl -X GET "$API_URL/api/initiatives"
```
...
db.buildings.find().limit(2).pretty();
"
